...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Forsikre deg om at videoen spiller av ved å sjekke om den er paused
  if (video.paused) {
    video.play().catch(() => {
      // Fallback for å vise brukeren at videoen kan spilles manuelt
      video.setAttribute('controls', 'controls');
    });
  }

  // Legg til event-lytter for å fjerne kontroller når videoen starter
